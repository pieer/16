...
<div v-if="$slidev.nav.clicks >= 1" v-motion
  ...
  <svg width="255" height="186" viewBox="0 0 255 186" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M113.34 0L23.63 30.59L8 99.23L42.49 157L202.37 157.34L254.71 94.47L223.61 23.11L113.34 0Z" stroke="#56ac8a" stroke-width="2" stroke-dasharray="1150" :stroke-dashoffset="direction === 'right' ? '58rem' : '-25.3rem'" fill="#FFF"/>
  </svg>
